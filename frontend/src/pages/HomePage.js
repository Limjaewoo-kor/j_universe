...
export default function HomePage() {
  ...
  return (
    <div className="bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 min-h-screen px-2 sm:px-4 py-8 sm:py-12 text-gray-800 dark:text-white">
      ...
      <section className="max-w-3xl mx-auto mb-12 sm:mb-20">
        <h2 className="text-base sm:text-xl font-bold text-gray-800 dark:text-white mb-4 sm:mb-6 text-center">예시 대화</h2>
        <div className="space-y-3 sm:space-y-4">
          <div className="flex items-start">
            <div className="bg-blue-100 dark:bg-blue-700 text-blue-800 dark:text-white px-3 py-2 rounded-xl max-w-[90%] sm:max-w-[75%] text-xs sm:text-base">
              안녕하세요 OOO입니다.
              이번 시험에 대한 결과는 평소보다 좀 더 빠르게 받아보고싶어요. 최대한 빨리 받아본다면 언제쯤 될까요?
            </div>
          </div>
          <div className="flex items-start justify-end">
            <div className="bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-white px-3 py-2 rounded-xl max-w-[90%] sm:max-w-[75%] text-xs sm:text-base">
              안녕하세요 OOO입니다.
